...
public class AddTaxiActivity extends AppCompatActivity {
    ...
    private static final int REQUEST_UPDATE_CONTACT = 2;
    SqliteDB_1501 mydb;
    @Override
    ...
    private void eventListener() {
        btnAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mydb.Insert(_soxe,_quangduong,_dongia,_phantram);
                Toast.makeText(AddTaxiActivity.this,"Update Suceess",Toast.LENGTH_SHORT).show();
                setResult(RESULT_OK);
            }
        });
